        ...
        <div className="w-full bg-slate-800 h-52 flex items-center justify-start gap-16 text-white">
            <div className="w-[70%] h-full">
                ...
                <div className="size-full flex justify-start items-center relative">
                    ...
                    <div className="w-full h-5 absolute flex items-center justify-start">
                        <div className={cn(
                            props.colorClass,
                            `w-[${rate_hundred}%]`,
                            "h-3 rounded-full")}
                    ...
                    <div
                        className="size-5 absolute left-[50%] bg-slate-700 -ml-3 rounded-full border-[3px] border-white">
                    ...
                    <div
                        className="size-5 absolute left-[90%] bg-slate-700 -ml-3 rounded-full border-[3px] border-white">
                        <div className="absolute top-[14px] left-1 flex flex-col items-start w-24">
                            <div>|</div>
                            <div>Top 90%: 24</div>
                        </div>
